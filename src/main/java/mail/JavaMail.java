...
// ---------------------------------------------------------基本資料
	...
	private String userName = "chimingchieh@gmail.com"; // 寄件者信箱
	private String password = "slcs vzzj zrhy xhjv"; // 寄件者密碼
	private String customer = "a2028290@gmail.com"; // 收件者郵箱
	private String subject = "你的入場卷號碼"; // 標題
